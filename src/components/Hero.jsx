      ...
      <div className="hero-trigger b h-[200vh] relative">
        <section className="hero z-[8] sticky top-0 h-[100vh] w-full py-[43px] pl-[37px] pr-[60px] flex items-end justify-center aspect-[1440/800] ">
          ...
          {/* <img
            ...
            alt=""
          /> */}
          <div className="z-[2] absolute inset-0 w-full h-full object-cover">
            <RippleImg imageSrc="/hero-img.png" />
          </div>

          {/* Container for typography */}
          <div className="flex overflow-hidden items-end justify-start gap-[80px] z-[5] relative text-white">
            <h1 className="text-[288px] font-bold leading-[80%] polymath pointer-events-none">
              Ether.fi
            </h1>

            <div className="max-w-[400px]">
              <p className="text-[48px] font-bold polymath leading-[100%] pointer-events-none">
                Save, Grow, Spend
              </p>
              <p className="text-[28px] font-medium leading-[120%] mt-[8px] text-white text-opacity-70 pointer-events-none">
